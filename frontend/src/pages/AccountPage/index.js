                            ...
                            <table className="table-product-list">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td className="quantity">90.000 ₫</td>
                                        <td className="discount-amount">90.000 ₫</td>
                                        <td className="total">90.000 ₫</td>
                                    </tr>
                                </tbody>
                                <tfoot>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span className="sum">103.700 ₫</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="4"></td>
                                        <td>
                                            <div title="Hủy đơn hàng" className="cancel-order">
