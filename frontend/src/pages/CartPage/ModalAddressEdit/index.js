...
function ModalAddressEdit({ show, handleHide, handleSave, infoAddress, setInfoAddress, validInfoAddress }) {
    ...
    return (
        <Modal size="lg" show={show} onHide={handleHide}>
            <Modal.Header closeButton>
                <Modal.Title>Thay đổi địa chỉ giao hàng </Modal.Title>
            </Modal.Header>
            <Modal.Body>
                <div className="ModalAddressEdit-container">
                    <div className="row">
                        <div className="col-6">
