...
class categoryController {
  ...
  async createFunc(req, res) {
    try {
      let data = await categoryApiService.handleCreateFunc(req.body);
  ...
  async deleteFunc(req, res) {
    try {
      let data = await categoryApiService.handleDeleteFunc(req.body);
  ...
  async editFunc(req, res) {
    try {
      let data = await categoryApiService.handleEditFunc(req.body);
